/**
 * Icon components matching the design system
 * Simple, clean icons without emojis
 */

import React from 'react';

export const MicrophoneIcon = ({ size = 20 }) => (
...
export const SpinnerIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="spinner-icon">
